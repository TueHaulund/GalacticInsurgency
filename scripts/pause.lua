...
local function setupPauseScreen()
    ...
    interface.loadSprite("pauseTextBox", "data/sprites/pausebox.tga")
    interface.setSpritePosition("pauseTextBox", screenCenter.x - 200, screenCenter.y - 100)
...
local function drawPauseScreen()
    ...
    interface.drawSprite("pauseTextBox")
